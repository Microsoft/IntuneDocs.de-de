...
- **PFX-Zertifikatconnector für Microsoft Intune:**  
  ...
  Weitere Informationen zu den Netzwerkendpunkten, auf die Intune und der Connector Zugriff benötigen, finden Sie unter [Netzwerkendpunkte für Microsoft Intune](intune-endpoints.md).
...
3. Laden Sie die Connectordatei herunter, und speichern Sie sie an einem Speicherort, auf den Sie über den Server zugreifen, auf dem Sie den Connector installieren werden.
    ...
    ![Herunterladen von Microsoft Intune Certificate Connector](media/certificates-pfx-configure/download-ndes-connector.png)
...
Lesen Sie auch die Artikel [Konfigurieren der Infrastruktur zur Unterstützung von SCEP in Intune](certificates-scep-configure.md) oder [Einrichten des Intune Certificate Connectors für den Symantec PKI-Manager-Webdienst](certificates-symantec-configure.md).
