...
description: Überprüfen Sie die Standardeinstellungen und verfügbaren Einstellungen für die verschiedenen Versionen der Windows MDM-Sicherheits-Baseline, die Sie mit Microsoft InTune verwalten können.
author: brenduns
ms.author: brenduns
manager: dougeby
ms.date: 09/06/2019
...
- **Standard für die virtualisierungsbasierte** 
  **Sicherheit: Aktivieren von VSB mit sicherem Start
::: zone-end
::: zone pivot="mdm-preview,mdm-may-2019"
...
Weitere Informationen finden Sie unter Richtlinien-Konfigurationsdienstanbieter: [RemoteAssistance in der Windows-Dokumentation.](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-remoteassistance#remoteassistance-solicitedremoteassistance)  
...
- **Netzwerkschutztyp**  
  ...
  [Erfahren Sie mehr](https://go.microsoft.com/fwlink/?linkid=2067102)  
...
*[Neu]* [**Windows Defender Firewall**](#windows-defender-firewall)
- **Firewall-Profil Domäne**  
  - **Eingehende Verbindungen blockiert**  
  - **Ausgehende Verbindungen erforderlich**  
  - **Eingehende Benachrichtigungen blockiert**  
