...
Für Geräte, auf denen Microsoft Edge installiert ist, sind [zwei neue Einstellungen](device-restrictions-windows-10.md#microsoft-edge-browser) verfügbar: **Pfad zur Favoritendatei** und **Änderungen an Favoriten**.
