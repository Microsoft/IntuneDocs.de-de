...
>[!NOTE]
>Sie müssen ein Intune-Dienstadministrator oder ein globaler Administrator sein, um ein Onlinesupportticket zu erstellen. Ausführliche Informationen finden Sie unter [Assigning administrator roles (Zuweisen von Administratorrollen)](https://docs.microsoft.com/azure/active-directory/active-directory-assign-admin-roles-azure-portal).
