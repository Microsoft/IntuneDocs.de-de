...
> [!NOTE]
> Die Informationen in diesem Thema gelten nur für Windows-Desktops, die Sie als PCs mithilfe des Intune-Softwareclients verwalten. Informationen zum Verwalten von Updates für Windows-PCs, die als mobile Geräte registriert sind, finden Sie unter [Verwalten von Software Updates in InTune](../protect/windows-update-for-business-configure.md).
