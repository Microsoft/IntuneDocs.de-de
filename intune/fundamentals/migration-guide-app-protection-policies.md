...
1. [Erstellen einer App-Schutzrichtlinie](../apps/app-protection-policies.md#create-an-app-protection-policy)
2. [Bereitstellen einer Richtlinie](../apps/app-protection-policies.md#deploy-a-policy-to-users)
