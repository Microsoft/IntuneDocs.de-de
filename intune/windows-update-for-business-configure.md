...
In Windows 10-Updateringen werden [Bereichstags](scope-tags.md) unterstützt. Sie können Bereichstags für Updateringe verwenden, um das Filtern und Verwalten der verwendeten Konfigurationen zu erleichtern.
...
- Windows Update unterstützt folgende Windows 10-Editionen:
  ...
  - Windows Holographic for Business  
    ...
    Weitere Informationen finden Sie unter [Verwalten und Verwenden verschiedener Geräteverwaltungsfeatures für Windows Holographic- und HoloLens-Geräten mit Intune](windows-holographic-for-business.md).  
...
- Auf Windows-Geräten muss **Feedback und Diagnose** > **Diagnose- und Nutzungsdaten** auf **Standard**, **Erweitert** oder **Vollständig** festgelegt sein.  
  ...
  Sie können diese Einstellung entweder manuell konfigurieren oder ein Intune-Geräteeinschränkungsprofil für Windows 10 und höher verwenden. Legen Sie die Einstellung **Allgemein** > **Übermittlung von Diagnosedaten** mindestens auf **Standard** fest, um das Geräteeinschränkungsprofil zu verwenden. Weitere Informationen zu Geräteprofilen finden Sie unter [Konfigurieren von Einstellungen für Geräteeinschränkungen](device-restrictions-configure.md).  
...
Wenn Sie einen Ring aus Intune löschen, werden dadurch nicht die Einstellungen auf Geräten geändert, denen der Updatering zugewiesen wurde.  Diese Geräte behalten ihre aktuellen Einstellungen bei. Das liegt daran, dass Geräte keinen Verlauf der vorherigen Einstellungen speichern. Außerdem könnten die Geräte Einstellungen von zusätzlichen Updateringen empfangen, die aktiv bleiben.  
