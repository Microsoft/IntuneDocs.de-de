...
Lösen Sie Probleme mit Softwareupdates in Microsoft Intune.
...
**Lösung**:  
1. Melden Sie sich im [Azure-Portal](https://portal.azure.com) an, und öffnen Sie **Microsoft Intune**. 
2. Klicken Sie auf **Softwareupdates**.
3. Lehnen Sie alle ersetzten Updates ab, die für Windows 7 oder Anwendungen (z. B. Microsoft Office) gelten, die auf den betroffenen Clients installiert wurden.
