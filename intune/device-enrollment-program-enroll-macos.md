...
Die Registrierung mit DEP funktioniert nicht mit dem [Geräteregistrierungs-Manager](device-enrollment-manager-enroll.md) oder [Apple School Manager](apple-school-manager-set-up-ios.md).
