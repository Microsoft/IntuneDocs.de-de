---
title: Erste Schritte mit Microsoft Intune im Azure-Portal
titlesuffix: ''
description: Erfahren Sie mehr über das Erstellen, Freigeben und Navigieren von Dashboards für Microsoft Intune im Azure-Portal.
keywords: ''
author: dougeby
ms.author: dougeby
manager: dougeby
...
ms.locfileid: "52180900"
---
# <a name="getting-started-with-microsoft-intune-in-the-azure-portal"></a>Erste Schritte mit Microsoft Intune im Azure-Portal

Sie finden den Microsoft Intune-Dienst im Azure-Portal. In Azure gibt es viele Dienste, von denen Sie einige nicht regelmäßig verwenden. Durch das Anpassen des Dashboards und der Randleiste in Azure finden Sie die benötigten Informationen schneller, wenn Sie sich für die Geräteverwaltung bei Intune anmelden.
