...
- *Windows-Version 1703*: 0 bis 180 Tagen  
...
- **Automatische Installation und Neustart zur geplanten Zeit**: Geben Sie einen Installationstag und eine -uhrzeit an. Wenn keine Angabe erfolgt, wird die Installation täglich um 3:00 Uhr ausgeführt, gefolgt von einem 15-minütigen Countdown bis zum Neustart. Angemeldete Benutzer können den Countdown und den Neustart verzögern.  
  ...
  **Windows-Referenzdokumentation**: [Update/AllowAutoUpdate](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-allowautoupdate)  
  ...
  - **Geplanter Installationstag**: Geben Sie auf den Tag der Woche Updates, die installiert werden sollen.  
    **Standard**: jeden Tag  

  - **Geplante Installationszeit**: Geben Sie die Tageszeit aus, wenn Sie Updates installieren möchten.  
    **Standard**: 3: 00 Uhr  
...
- **Standardeinstellung**: *Diese Einstellung ist nicht standardmäßig konfiguriert, und Benutzern wird keine Erinnerung angezeigt*.  
...
- **Windows-Version**: für Windows 10 unterstützt Version 1803 und höher  
...
- **Erneut erinnern bei erzwungener Neustarterinnerung (Tage)**  
  - **Standardeinstellung**: Diese Option ist standardmäßig nicht konfiguriert, es werden aber Werte von **1** bis **3** unterstützt.  
