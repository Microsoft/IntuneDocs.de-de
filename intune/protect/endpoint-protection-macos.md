...
- **FileVault**  
  ...
  **Standardeinstellung:** Nicht konfiguriert  
  ...
  Legen Sie fest, wie oft ein Benutzer Aufforderungen zum Aktivieren von "flevault" ignorieren kann, bevor "flevault" für die Anmeldung durch den Benutzer erforderlich ist. 
    ...
    **Standard**: *variiert* : Wenn die Einstellung *Eingabeaufforderung beim Abmelden deaktivieren* auf **nicht konfiguriert**festgelegt ist, ist diese Einstellung standardmäßig **nicht konfiguriert**. Wenn die Option *Aufforderung beim Abmelden deaktivieren* auf **Deaktivieren**festgelegt ist, ist diese Einstellung standardmäßig auf **1** festgelegt, und der Wert ist **nicht konfiguriert** .
