...
- **Minimaler TLS-Versionsbereich**: Geben Sie die mindestens zu verwendende TLS-Version ein. Geben Sie `1.0`, `1.1` oder `1.2` ein. Wenn Sie das Feld leer lassen, wird der Standardwert `1.0` verwendet.
